import { Role } from '.'
import { alertService } from '@/_api_services';

// array in local storage for registered users
const usersKey = 'cash-trash-app-signup-verification-authention';
            ...
            function register() {
                ...
                setTimeout(() => {
                    ...
                    alertService.info(`
                        ...
                        <p>Thanks for registering on Our Plateform!</p>
                        <p>Please click the below link to verify your email address:</p>
                        <p><a href="${verifyUrl}">${verifyUrl}</a></p>
                        <div><strong>NOTE:</strong> The CashApp fake backend displayed this "email" so you can test without an api. A real backend would send a real email.</div>
                    `, { autoClose: false });
                }, 1000);
            ...
            function forgotPassword() {
                ...
                setTimeout(() => {
                    ...
                    alertService.info(`
                        ...
                        <div><strong>NOTE:</strong> The Cash App fake backend displayed this "email" so you can test without an api. A real backend would send a real email.</div>
                    `, { autoClose: false });
                }, 1000);
